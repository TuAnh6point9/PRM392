Future<void> downloadFileAsync() async {
  print('Bat dau tac vu bat dong bo (mo phong tai tep qua mang trong 4 giay)...');
...
void main() async {
  ...
  print('Lenh ngay sau downloadFileAsync(): ${stopwatch.elapsedMilliseconds} ms '
      '(chay ngay, khong doi tac vu bat dong bo)');

  // Doi Future hoan thanh de thay thoi gian tong cong va gia tri cuoi.
  await future;

  print('Toan bo chuong trinh hoan tat sau: ${stopwatch.elapsedMilliseconds} ms');
  stopwatch.stop();
}
